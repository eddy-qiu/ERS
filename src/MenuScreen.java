...
implements ActionListener{
	...
	JLabel titleText, ruleImage,tutorialImage, topCard,
	leftCard, rightCard,
	bottomCard, empty1, empty2, empty3, empty4, empty5;
	JComboBox topCardDiff;
	ImageIcon Rule1, Rule2, Rule3, Tutorial1, Tutorial2,
	...
	public MenuScreen(){
		...
		topCardPanel.setLayout(new BoxLayout(topCardPanel,
				BoxLayout.Y_AXIS));
		...
		ruleFrame.setDefaultCloseOperation
		(JFrame.EXIT_ON_CLOSE);
		...
		Rule1 = new ImageIcon
				("Rules and Tutorial/RuleImg1.png");
		Rule2 = new ImageIcon
				("Rules and Tutorial/RuleImg2.png");
		Rule3 = new ImageIcon
				("Rules and Tutorial/RuleImg3.png");
		
		Image image3 = Rule1.getImage();
		Image newimg3 = image3.getScaledInstance(720, 360,
				java.awt.Image.SCALE_SMOOTH);
		Rule1 = new ImageIcon(newimg3);
		ruleImage = new JLabel(Rule1);
		
		ruleTextPanel = new JPanel();
		ruleTextPanel.setLayout(new BoxLayout(ruleTextPanel,
				BoxLayout.Y_AXIS));
		ruleTextPanel.setBorder(BorderFactory.
		...
		rulebuttonPanel.setLayout(new BoxLayout
				(rulebuttonPanel, BoxLayout.Y_AXIS));
		rulebuttonPanel.setBorder(BorderFactory.
				createEmptyBorder(0, 20, 10, 20));
		...
		tutorialFrame.setDefaultCloseOperation
		(JFrame.EXIT_ON_CLOSE);
		...
		Tutorial1 = new ImageIcon
				("Rules and Tutorial/TutorialImg1.png");
		Tutorial2 = new ImageIcon
				("Rules and Tutorial/TutorialImg2.png");
		Tutorial3 = new ImageIcon
				("Rules and Tutorial/TutorialImg3.png");
		Tutorial4 = new ImageIcon
				("Rules and Tutorial/TutorialImg4.jpg");
		Tutorial5 = new ImageIcon
				("Rules and Tutorial/TutorialImg5.png");
		
		Image image4 = Tutorial1.getImage();
		Image newimg4 = image4.getScaledInstance
				(620, 600, java.awt.Image.SCALE_SMOOTH);
		Tutorial1 = new ImageIcon(newimg4);
		tutorialImage = new JLabel(Tutorial1);
		
		tutorialTextPanel = new JPanel();
		tutorialTextPanel.setLayout(new BoxLayout
				(tutorialTextPanel, BoxLayout.Y_AXIS));
		tutorialTextPanel.setBorder(BorderFactory.
				createEmptyBorder(0, 17, 25, 17));
		...
		tutorialPanel.add(tutorialTextPanel, 
				BorderLayout.CENTER);
		
		tutorialButtonPanel = new JPanel();
		tutorialButtonPanel.setLayout(new BoxLayout
				(tutorialButtonPanel, BoxLayout.Y_AXIS));
		tutorialButtonPanel.setBorder(BorderFactory.
				createEmptyBorder(0, 20, 20, 20));
		...
		tutorialPanel.add(tutorialButtonPanel, 
