...
public class MenuScreen extends JPanel implements ActionListener {
	...
	GamePanel game;
	JPanel mainPanel, titlePanel, rulePanel, rulebuttonPanel, ruleTextPanel, menuButtonPanel, rightPanel, leftPanel,
			topCardPanel, tutorialPanel, tutorialTextPanel, tutorialButtonPanel;
	JButton start, tutorialButton, ruleButton, nextPage, backToMain, tutorialbackToMain, tutorialnextPage;
	JLabel titleText, ruleImage, tutorialImage, topCard, leftCard, rightCard, bottomCard, empty1, empty2, empty3,
			empty4, empty5;
	...
	public MenuScreen() {
		...
		rulePanel.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
		tutorialPanel.setBorder(BorderFactory.createEmptyBorder(0, 0, 18, 0));
